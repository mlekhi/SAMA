...
class Input_Data:
    def __init__(self):
        ...
        if load_type == 1:
            ...
            self.Annual_total_load = 12879.10  # Define the annual hourly average for load here
            peak_month = 'July'
        ...
        elif self.load_previous_year_type == 3:
        ...
        elif self.load_previous_year_type == 4:
        ...
        elif self.load_previous_year_type == 5:
        ...
        elif self.load_previous_year_type == 6:
            peak_month = 'July'
            user_defined_load = np.array([300, 350, 320, 320, 320, 320, 320, 320, 320, 320, 320, 320])  # Define the monthly total load here

            from generic_load import generic_load
            self.Eload_Previous = generic_load(1, self.load_previous_year_type, peak_month, self.daysInMonth, user_defined_load)

        elif self.load_previous_year_type == 7:
        ...
        elif self.load_previous_year_type == 8:
        ...
        elif self.load_previous_year_type == 9: # Annual total load for previous year
            self.Annual_total_load = 12000  # Define the annual hourly average for load here
            peak_month = 'July'

            from generic_load import generic_load
            self.Eload_Previous = generic_load(1, self.load_previous_year_type, peak_month, self.daysInMonth, self.Annual_total_load)

        else:
            peak_month = 'July'

            from generic_load import generic_load
            self.Eload_Previous = generic_load(1, self.load_previous_year_type, peak_month, self.daysInMonth, 1)
        ...
        self.WS_type = 1 # Determine the way you want to input the Wind speed by choosing one of the numbers above
