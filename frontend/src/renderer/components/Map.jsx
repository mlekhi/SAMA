...
function ResetCenterView(props) {
  ...
  useEffect(() =>{
    if(selectPosition && selectPosition.lat && selectPosition.lon && 
       !isNaN(selectPosition.lat) && !isNaN(selectPosition.lon)){
...
export default function Map(props){
  const {selectPosition, onMapClick} = props;
  
  // Only create locationSelection if we have valid coordinates
  const locationSelection = (selectPosition && 
                           selectPosition.lat && 
                           selectPosition.lon && 
                           !isNaN(selectPosition.lat) && 
                           !isNaN(selectPosition.lon)) 
